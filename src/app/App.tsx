      ...
      {(currentView === "home" || currentView === "catalog") && (
        <div className="w-full bg-white border-t border-slate-100">
          <div className="w-full py-1">
            ...
            >
              <div className="relative w-full overflow-visible bg-gradient-to-b from-gray-50 to-gray-100 flex items-start justify-center min-h-[380px] sm:min-h-[460px] md:min-h-[540px] lg:min-h-[640px] xl:min-h-[720px] py-4 sm:py-5 md:py-6 px-0">
                <img
                  src={promoBanner}
