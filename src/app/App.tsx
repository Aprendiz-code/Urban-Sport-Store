  ...
  return (
    <main className="pt-[132px] min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 relative overflow-hidden bg-slate-900">
        <img src="https://images.unsplash.com/photo-1519744792095-2f2205e87b6f?w=1600&h=1200&fit=crop&auto=format&auto=compress&q=80"
          alt="Gimnasio y zapatillas" className="absolute inset-0 w-full h-full object-cover" />
