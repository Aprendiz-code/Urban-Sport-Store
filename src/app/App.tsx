...
function Btn({
  ...
  const variants = {
    primary:   "bg-[#1d4ed8] text-white hover:bg-[#1e40af] active:scale-[0.98] shadow-sm shadow-blue-200",
    secondary: "bg-slate-100 text-slate-700 hover:bg-slate-200",
    outline:   "border-2 border-[#1d4ed8] text-[#1d4ed8] hover:bg-blue-50",
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button onClick={handleAdd}
              className={`flex-1 py-3.5 rounded-xl text-sm font-extrabold flex items-center justify-center gap-2 transition-all duration-300 ${
                added ? "bg-emerald-500 text-white shadow-lg shadow-emerald-200" : "bg-[#1d4ed8] text-white hover:bg-[#1e40af] shadow-lg shadow-blue-200"
              }`}>
            ...
            <button onClick={() => { handleAdd(); onNavigate("checkout"); }}
              className="flex-1 py-3.5 rounded-xl text-sm font-extrabold border-2 border-[#1d4ed8] text-[#1d4ed8] hover:bg-blue-50 flex items-center justify-center gap-2 transition-colors">
              Comprar ahora
            </button>
          </div>
