      ...
      {(currentView === "home" || currentView === "catalog") && (
        <div className="w-full bg-white border-t border-slate-100">
          <div className="w-full py-1">
            ...
            >
              <div className="relative w-full overflow-visible bg-gradient-to-b from-gray-50 to-gray-100 flex items-center justify-center min-h-[380px] sm:min-h-[460px] md:min-h-[540px] lg:min-h-[640px] xl:min-h-[720px] py-5 sm:py-6 md:py-7 px-0">
                <img
                  src={promoBanner}
          ...
          <div className="border-t border-slate-100 overflow-x-auto mt-10">
