      ...
      {(currentView === "home" || currentView === "catalog") && (
        <div className="w-full bg-white border-t border-slate-100">
          <div className="w-full py-1">
            ...
            >
              <div className="relative w-full overflow-visible bg-gradient-to-b from-gray-50 to-gray-100 flex items-start justify-center min-h-[360px] sm:min-h-[440px] md:min-h-[520px] lg:min-h-[600px] xl:min-h-[680px] py-4 sm:py-5 md:py-6 px-0">
                <img
                  src={promoBanner}
